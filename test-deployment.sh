...
STATUS=$(curl -s -o /dev/null -w "%{http_code}" https://app.interactivecheckout.com)
...
echo "      App URL: https://app.interactivecheckout.com"
echo "      Redirect URL: https://app.interactivecheckout.com/api/auth"
echo "   → Click Save"
echo ""
